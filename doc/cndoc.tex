...
% windows
\newcommand\setwindowsfonts[1]{#1}
\renewcommand\setwindowsfonts[1]{}
\setwindowsfonts{
	\renewcommand\mymainfont{Bookman Old Style}%{Book Antiqua}%{Times New Roman}
	\renewcommand\mymonofont{Lucida Sans Typewriter}
	\renewcommand\myboldfont{Microsoft YaHei}
	\renewcommand\mysansfont{Arial}
	\renewcommand\myitalicfont{Bookman Old Style}%{Book Antiqua}%{Times New Roman} %{Garamond}
	
	\renewcommand\mycjkboldfont{Microsoft YaHei}
	\renewcommand\mycjkitalicfont{DFKai-SB} %{Adobe Kaiti Std}
	\renewcommand\mycjkmainfont{MingLiU} %{AR PL UMing CN}%{Adobe Song Std}%{仿宋}%{宋体}%{新宋体}%{文鼎ＰＬ新宋}%
	\renewcommand\mycjksansfont{MingLiU} %{Adobe Ming Std}
	\renewcommand\mycjkmonofont{Microsoft YaHei}
	
	\renewcommand\myurlfont{Agency FB}
} % windows
